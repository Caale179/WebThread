...
public final class Tools {
    ...
    private static final List<String> startingURL = new LinkedList<>();
        ...
        for (String input : args) {
            if (input.charAt(0) == '-') {
                ...
                if ((input.charAt(1) != '-' && input.contains("h")) || input.equals("--help")) {
                    ...
                    System.out.println("\t    --threads=n\t\t\tParallels the search amongst n threads");
                }
    ...
    public static ParsedPage parsePage(final String address) throws IOException {
        ...
        if (offline) {
            ...
            doc = Jsoup.connect(address).timeout(100 * 1000).get();
        }
